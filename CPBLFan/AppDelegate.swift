...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        if let shortcutItem = launchOptions?[UIApplication.LaunchOptionsKey.shortcutItem] as? UIApplicationShortcutItem {
            ...
            let _ = handleShortoutAction(shortcutItem)
        }
    ...
    func application(_ application: UIApplication, performActionFor shortcutItem: UIApplicationShortcutItem, completionHandler: @escaping (Bool) -> Void) {
        completionHandler(handleShortoutAction(shortcutItem))
    }
    ...
    private func handleShortoutAction(_ shortcutItem: UIApplicationShortcutItem) -> Bool {
        var tabIndex = 0
        
        switch shortcutItem.type {
        case "Schedule": tabIndex = 1
        case "Rank": tabIndex = 2
        case "Statistics": tabIndex = 3
        case "Videos": tabIndex = 4
        default: break;
        }
